...
#Filter nebs_temps_full where survey_definition_id = 143 for NBS survey. Then add cold pool index .csv data into nebs_temps_full
...
#ebs_nbs_temps_filt <-filter(ebs_nbs_temps_full, !is.na(gear_temperature))
